...
constexpr auto ass_sc_style_format =
R"(Style: sc,{font_name},{font_size},&H{font_alpha}{font_color},&H{font_alpha}FFFFFF,&H00000000,&H{font_alpha}66A514,{font_bold},0,0,0,100,100,0,0,1,{font_outline},{font_shadow},7,0,0,0,0
)"; // \n here

constexpr auto sc_ass_header_format =
R"([Script Info]
Title: {title}
ScriptType: v4.00+
PlayResX: {play_res_x}
